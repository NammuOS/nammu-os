                ...
                {files.map((file) => {
                  ...
                  return (
                    <div
                      ...
                      className={`grid w-full cursor-pointer grid-cols-[1fr_130px_110px_90px_70px_110px] items-center px-3 py-2 text-left text-[#c9d7e2] transition-colors ${
                        isActive ? 'bg-[#4aa3ff]/10' : 'hover:bg-white/[0.02]'
                      }`}
                    >
                      ...
                      <div className="flex items-center justify-end gap-1.5 pr-1">
                        ...
                        <button
                          onClick={(event) => {
                            event.stopPropagation();
                            void onDeletePermanently(file.id);
                          }}
        ...
        <CloudResourceInspector
          ...
          actions={
            activeFile ? (
              <>
                <button
                  onClick={() => void onRestore(activeFile.id)}
                ...
                <button
                  onClick={() => void onDeletePermanently(activeFile.id)}
