...
import { Star, File, FileText, Film, Folder, Image as ImageIcon, Music } from 'lucide-react';
...
export default function CloudStarredView({
  files,
  onOpenFile,
  onPreviewFile,
  onToggleStar,
      ...
      <div className="flex h-9 shrink-0 items-center justify-between border-b border-white/[0.06] bg-white/[0.01] px-3">
        <div className="flex items-center gap-2">
          ...
          <span className="font-mono text-[9px] uppercase tracking-[0.2em] text-[#556f84]">
            Starred Resources ({filtered.length})
          </span>
        </div>
        <input
          value={search}
          onChange={(e) => setSearch(e.target.value)}
          placeholder="Filter starred resources"
